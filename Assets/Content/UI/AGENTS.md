...
- Keep the older post-import numbered-duplicate resolver as a best-effort cleanup when the Project-window drop interception did not run, such as dropping onto Project-window whitespace. It may resolve simple suffixes such as `name1.png`, `name 1.png`, or `name_1.png`, and may resolve a same-prefix consecutive batch such as Unity-created `name_5.png`, `name_6.png`, `name_7.png` back to existing `name_2.png`, `name_3.png`, `name_4.png`.
